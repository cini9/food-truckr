...
food_truck4 = FoodTruck.create(name: 'Be Burger', category: 'burger', city: 'Renens', description: 'Ready to taste your best burger of your life? Invite your buddies and reserve my foodtruck for one night', user_id: foodtrucker4.id, photo: "assets/images/burger.jpg" , price_cents: 100000)
...
food_truck7 = FoodTruck.create(name: 'Gastro Burger', category: 'burger', city: "Geneva", description: 'You like Gastronomy and Burger? Now, make your reservation on Foodtruckr!', user_id: foodtrucker7.id, photo: "assets/images/burger_gourmet.jpg" , price_cents: 15000)
